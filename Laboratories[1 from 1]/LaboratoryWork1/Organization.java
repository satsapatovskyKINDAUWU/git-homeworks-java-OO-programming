...
public class Organization{
   ...
   void deleteOrganization(){
        ...
        if(localOrganizations.size()>0) {
            ...
            System.out.println("Наразі немає жодної організації у списку");
        }
   }
    ...
    void addNewOrganization(){
        ...
        addOrg.reset();
        System.out.println("Ви успішно добавили організацію:"+name+ "|  Адреса:"+address+"|  Директор/СЕО:"+ director+"/  Тел.номер:"+number);
